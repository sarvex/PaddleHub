...
inp_shape = {"b1": [240, 120, 120, 60, 30, 15, 15, 8]}
...
@moduleinfo(
    ...
    author="paddlepaddle",
    author_email="",
    summary="efficientnetb1_imagenet is a classification model, "
    "this module is trained with Imagenet dataset.",
    version="1.1.0",
    meta=ImageClassifierModule)
class EfficientNet_B1(nn.Layer):
    def __init__(self,
                 is_test: bool = False,
                 padding_type: str = "SAME",
        ...
        if load_checkpoint is not None:
            ...
            checkpoint = os.path.join(self.directory, 'efficientnet_b1_imagenet.pdparams')
            if not os.path.exists(checkpoint):
                os.system(
                    f'wget https://paddlehub.bj.bcebos.com/dygraph/image_classification/efficientnet_b1_imagenet.pdparams -O {checkpoint}'
                )
