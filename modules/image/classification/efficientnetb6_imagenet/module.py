...
inp_shape = {"b6": [528, 264, 264, 132, 66, 33, 33, 17]}
...
@moduleinfo(
    name="efficientnetb6_imagenet",
    type="cv/classification",
    author="paddlepaddle",
    author_email="",
    summary="efficientnetb6_imagenet is a classification model, "
    "this module is trained with Imagenet dataset.",
    version="1.1.0",
    meta=ImageClassifierModule)
class EfficientNet_B6(nn.Layer):
    def __init__(self,
                 is_test: bool = False,
                 padding_type: str = "SAME",
        ...
        if load_checkpoint is not None:
            ...
            checkpoint = os.path.join(self.directory, 'efficientnet_b6_imagenet.pdparams')
            if not os.path.exists(checkpoint):
                os.system(
                    f'wget https://paddlehub.bj.bcebos.com/dygraph/image_classification/efficientnet_b6_imagenet.pdparams -O {checkpoint}'
                )
