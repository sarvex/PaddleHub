...
@moduleinfo(
    ...
    author="paddlepaddle",
    author_email="",
    summary="efficientnet_b0_small_imagenet is a classification model, "
    ...
    def __init__(self,
        ...
        if load_checkpoint is not None:
            ...
            if not os.path.exists(checkpoint):
                os.system(
                    f'wget https://paddlehub.bj.bcebos.com/dygraph/image_classification/efficientnet_b0_small_imagenet.pdparams -O {checkpoint}'
                )
