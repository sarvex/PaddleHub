...
inp_shape = {"b3": [300, 150, 150, 75, 38, 19, 19, 10]}
...
@moduleinfo(
    ...
    author="paddlepaddle",
    author_email="",
    summary="efficientnetb3_imagenet is a classification model, "
    "this module is trained with Imagenet dataset.",
    version="1.1.0",
    meta=ImageClassifierModule)
class EfficientNet_B3(nn.Layer):
    def __init__(self,
                 is_test: bool = False,
                 padding_type: str = "SAME",
        ...
        if load_checkpoint is not None:
            ...
            checkpoint = os.path.join(self.directory, 'efficientnet_b3_imagenet.pdparams')
            if not os.path.exists(checkpoint):
                os.system(
                    f'wget https://paddlehub.bj.bcebos.com/dygraph/image_classification/efficientnet_b3_imagenet.pdparams -O {checkpoint}'
                )
