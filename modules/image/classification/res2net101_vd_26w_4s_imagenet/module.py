...
from res2net101_vd_26w_4s_imagenet.processor import postprocess, base64_to_cv2
from res2net101_vd_26w_4s_imagenet.data_feed import reader
from res2net101_vd_26w_4s_imagenet.res2net_vd import Res2Net101_vd_26w_4s
...
@moduleinfo(
    ...
    version="1.0.0")
class Res2Net101vd26w4sImagenet(hub.Module):
